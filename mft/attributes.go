...
func ParseFileName(attr interface{}) (FileName, error) {
        var b []byte
        ...
        case Attribute:
                if !v.Resident {
                        return FileName{}, fmt.Errorf("non-resident $FILE_NAME attribute not supported")
                }
                b = v.Data
        default:
                return FileName{}, fmt.Errorf("unsupported attribute type: %T", attr)
        }
