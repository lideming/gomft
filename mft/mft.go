...
// IsInUse returns true if the record is in use
func (r Record) IsInUse() bool {
        return r.Flags&RecordFlagInUse != 0
}

// IsDirectory returns true if the record is a directory
func (r Record) IsDirectory() bool {
        return r.Flags&RecordFlagIsDirectory != 0
}

// RecordNumber returns the record number
func (r Record) RecordNumber() uint64 {
        return r.FileReference.RecordNumber
}
